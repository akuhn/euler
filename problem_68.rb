...
def pentagon_ring
  [*1..10].reverse.permutation do |a,b,c,d,e,v,w,x,y,z|
    sum = a+v+w
    next unless 
      b+w+x == sum &&
      c+x+y == sum &&
      ...
      e+z+v == sum &&
      a < b && a < c && a < d && a < e
    str = [[a,v,w],[b,w,x],[c,x,y],[d,y,z],[e,z,v]].flatten.join
    next unless str.size == 16
    return str.to_i
  end
end

tetragon_ring.should == 432621513
pentagon_ring.should == 6531031914842725
